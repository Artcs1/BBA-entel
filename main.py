...
from datasets.dataset_entel import ENTEL
...
def parse_args():
    ...
    parser.add_argument('--resume', type=str, default='model_40.pth', help='Weights resumed in testing and evaluation')
    parser.add_argument('--dataset', type=str, default='dota', help='Name of dataset')
    parser.add_argument('--data_dir', type=str, default='./data/dota', help='Data directory')
...
if __name__ == '__main__':
    args = parse_args()
    dataset = {'dota': DOTA, 'hrsc': HRSC, 'entel':ENTEL}
    num_classes = {'dota': 15, 'hrsc': 1, 'entel': 2}
